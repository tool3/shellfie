...
I spent way too long looking for a simple library that converts terminal output to clean, scalable images. Every solution I found either required native dependencies, spawned headless browsers, or needed half of Chromium just to render some colored text.
