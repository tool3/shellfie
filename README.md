...
shellfie(input, {
  ...
  watermarkPadding: 16,                       // watermark offset from edges
  ...
  customGlyphs: true,                         // pixel-perfect box drawing
  header: { backgroundColor: '#2d2d2d' },     // title bar styling
  footer: { backgroundColor: '#2d2d2d' },     // footer bar styling
});
```
